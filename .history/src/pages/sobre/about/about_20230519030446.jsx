    ...
    <section id='about' className='sobre-section'>
      <main>
        <div className='sobre-left'>
          ...
          <Link style={{ textDecoration: 'none' }} onClick={showNavbar} spy={true} smooth={true} offset={100} duration={500} to='form' ><button className='solid'>Contato</button></Link>
            <a><button className='transparent'>Veja o portfólio</button></a>
          </div>
        </div>
