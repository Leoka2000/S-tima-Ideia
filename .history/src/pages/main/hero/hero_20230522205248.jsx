  ...
  return (
    <section id='inicio' className="hero-section">
      <div className="hero-wrapper">
        ...
        <h2>Clique no botão a baixo para saber mais.</h2>
        <div>
          <Link to='sobre' className="colored-hero" style={{textDecoration: 'none'}} spy={true} smooth={true} offset={100} duration={500}>Descubra mais</Link>
        </div>
      </div>
    </section>
  );
