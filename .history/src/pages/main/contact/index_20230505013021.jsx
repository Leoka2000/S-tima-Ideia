      ...
      <motion.header
        ...
        <div className='row-wrapper'>
          <div>
            ...
            <p>Envie-me uma mensagem no Instagram e uma foto de referência ou mencione a ID de um dos meus trabalhos presentes na seção de portfólio deste site.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p>Exijo 48 horas de antecedência para reagendar ou cancelar um agendamento. Se você não conseguir fazer isso, precisará marcar outro agendamento e pagar um depósito extra.</p>
          </div>
          <div>
