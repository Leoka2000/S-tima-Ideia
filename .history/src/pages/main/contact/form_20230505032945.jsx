            ...
            <motion.form
                ...
                <div className='flex-div'>
                    <fieldset className='form-row'>
                        ...
                        {errors.firstName && <span className="error-message">Por favor, insira o seu nome</span>}
                    </fieldset>
                    <fieldset className='form-row'>
                        ...
                        {errors.lastName && <span className="error-message">Por favor, insira o seu sobrenome</span>}
                    </fieldset>
                </div>
                <fieldset id='checkbox-wrapper' className='form-row'>
                    ...
                    {errors.checkbox && <span className="error-message">Por favor, selecione a caixa acima</span>}
                </fieldset>
                <div className='flex-div'>
                    <fieldset className='form-row'>
                        ...
                        {errors.phone && <span className="error-message">Por favor, insira um telefone válido</span>}
                    </fieldset>
                    <fieldset className='form-row'>
                ...
                <fieldset className='form-row'>
                    ...
                    {errors.message && <span className="error-message">Insira um conteúdo</span>}
                </fieldset>
