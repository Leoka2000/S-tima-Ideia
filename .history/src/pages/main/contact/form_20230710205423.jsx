...
const Form = () => {
    ...
    const [ref1, inView1] = useInView({
     ...
     const sendEmail = (data) => {
         emailjs.send('service_cccr2pm', 'template_5qhui9d', data, 'gO1uoQT1AmEmllMjb')
             .then((response) => {
        ...
        <section id='form' className='form-section'>
            ...
            <motion.form
                ...
                <fieldset id='checkbox-wrapper' className='form-row'>
                    <label htmlFor="checkbox" className="form-label">Eu confirmo que eu tenho mais de 18 anos</label>
