  ...
  return (
    <section id='about' className='about-section'>
      <motion.main
        ...
        <h2>
        com mais de 5 anos de experiência, exploro a linha artistica das tatuagens preto e cinza (black and grey), não limitando somente à este estilo de tatuagem.
        </h2>
        <div>
          <img src={tattoogun} />
          <div>
