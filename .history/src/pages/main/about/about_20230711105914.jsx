    ...
    <section id='sobre' className='about-section'>
      <motion.main
        ...
        <div>
          ...
          <div>
            <h1>COM AMOR</h1>
            <p>Sendo artista por natureza, meu processo criativo envolve toda a minha relação com a arte, sendo através pinturas, fotografias, desenhos, documentários, histórias de vida ou exposições artísticas. Fazendo assim com que cada trabalho seja feito única e exclusiva.</p>
          </div>
        </div>
