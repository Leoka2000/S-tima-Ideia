    ...
    return (
        <footer>
            ...
            <div className='footer-middle'>
                ...
                <Link style={{ textDecoration: 'none' }} spy={true} smooth={true} offset={100} duration={500} to='portfólio' >Sobre</Link>
                <Link style={{ textDecoration: 'none' }} spy={true} smooth={true} offset={100} duration={500} to='about' >Portfólio</Link>
            </div>
