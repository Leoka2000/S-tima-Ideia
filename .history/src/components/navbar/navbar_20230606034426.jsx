    ...
    <div className='nav-parent'>
      <nav className={navbar ? 'navbar' : 'activated'}>
        <div className='responsive-div' ref={navRef}>
          ...
          <div className='bagé'>
            <a className='família' style={{ textDecoration: 'none', color: '#fff' }} target='_blank' href='https://www.facebook.com/familiabagetattoo/?locale=pt_BR' onClick={showNavbar}>Familia Bagé</a>
            {location.pathname === '/' && (
